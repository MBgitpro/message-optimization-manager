...
/**
 * @param {Partial<DialogHeaderProps> & React.HTMLAttributes<HTMLDivElement>} props
 */
const DialogHeader = ({
  className,
  ...props
...
/**
 * @type {React.ForwardRefExoticComponent<DialogTitleProps & React.RefAttributes<HTMLParagraphElement>>}
 */
